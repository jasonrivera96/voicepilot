    ...
    <View style={styles.container}>
      ...
      <Text style={styles.title}>{titulo}</Text>
        ...
        <View style={styles.centeredView}>
          ...
          {/* TEMAS */}
          <TouchableOpacity onPress={() => handleOpenModal('Temas Destacados',  COLORS.GRAY , 'folder-open-o', COLORS.GRAY_SOFT)} 
          ...
          {/* FECHAS  */}
          <TouchableOpacity onPress={() => handleOpenModal('Fechas importantes',  COLORS.Pastel_Orange , 'calendar-o', COLORS.Pastel_Orange_1)} 
          style={[styles.post]}>
            <View style={styles.firstColumn}>
          ...
          {/* Preguntas */}
          <TouchableOpacity onPress={() => handleOpenModal('Preguntas',  COLORS.Pastel_Pink , 'question', COLORS.Pastel_Pink_1)} 
          ...
          {/* Tareas */}
          <TouchableOpacity onPress={() => handleOpenModal('Tareas',  COLORS.Pastel_Blue  , 'tasks', COLORS.Pastel_Blue_1)} 
